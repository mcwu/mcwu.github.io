try {
  ...
  if (typeof QSI.global === 'undefined') {
    QSI.global = {
      ...
      imagePath: 'https://znci39qilcumkr0dn-rogersdigital.siteintercept.qualtrics.com/WRSiteInterceptEngine/../WRQualtricsShared/Graphics/',
      graphicPath: 'https://ca1.qualtrics.com/WRQualtricsSiteIntercept/Graphic.php?IM=',
      modulePath: 'https://a248.e.akamai.net/img.qualtrics.com/WRQualtricsShared/JavaScript/SiteInterceptEngine/',
      intercepts: {},
      eventTrackers: [],
      clientType: 'web',
      clientVersion: 'SIE.2019.01.1'
    };
  }
      QSI.global.legacyId = 'ZN_cI39qiLcUmKR0dn';
  QSI.global.baseURL = QSI.overrides.baseURL || 'https://siteintercept.qualtrics.com';
